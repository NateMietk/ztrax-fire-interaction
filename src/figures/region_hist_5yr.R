...
ggsave("results/region/bui/bui_east_hist_per5yr.pdf", g, width = 12, height = 5, dpi=600, scale = 4, units = "cm") #saves g
...
g <- arrangeGrob(firefreq_90, firefreq_95, firefreq_00, firefreq_05, firefreq_10, firefreq_15, nrow = 1)
ggsave("results/region/bui/bui_west_hist_per5yr.pdf", g, width = 12, height = 5, dpi=600, scale = 4, units = "cm") #saves g
...
g <- arrangeGrob(firefreq_90, firefreq_95, firefreq_00, firefreq_05, firefreq_10, firefreq_15, nrow = 1)
ggsave("results/region/bui/bui_central_hist_per5yr.pdf", g, width = 12, height = 5, dpi=600, scale = 4, units = "cm") #saves g
